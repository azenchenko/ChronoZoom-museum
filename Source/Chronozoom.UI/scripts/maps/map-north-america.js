...
(function (CZ) {
    (function (Map) {
        ...
        Map.prototype.MapNorthAmerica = function (mapData, timeline) {
            _this = this;
        ...
        function loadMap (mapData) {
            ...
            d3.json("maps-topojson/north-america.json", function (error, map) {
                if (error) {

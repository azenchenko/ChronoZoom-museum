...
(function (CZ) {
    (function (Map) {
        ...
        Map.prototype.MapEurasia = function (mapData, timeline) {
            _this = this;
        ...
        function loadMap (mapData) {
            ...
            d3.json("maps-topojson/eurasia.json", function (error, map) {
                if (error) {
                    return console.error(error);
                }

                // Initial projection.
                _this.projection = d3.geo.equirectangular()
                    .scale(1)
                    .translate([0, 0]);
                ...
                // Centerin map view.
                var b = _this.path.bounds(topojson.feature(map, map.objects.countries))

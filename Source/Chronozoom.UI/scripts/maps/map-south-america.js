...
(function (CZ) {
    (function (Map) {
        ...
        Map.prototype.MapSouthAmerica = function (mapData, timeline) {
            _this = this;
        ...
        function loadMap (mapData) {
            ...
            d3.json("maps-topojson/south-america.json", function (error, map) {
                if (error) {
